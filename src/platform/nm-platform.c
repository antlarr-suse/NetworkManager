 ...
 * @dirfd: optional file descriptor for parent directory for openat()
 * @path: absolute option path
 * @values: NULL-terminated array of stringsl to be written
 ...
 * blocking the main thread. When the function returns
 * %TRUE the callback is always called. The callback
 * is never invoked synchronously.
 */
void
